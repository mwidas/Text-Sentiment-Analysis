...
# returns: A LDA_Gibbs topic model with 3 topics.
topicModel_k3
```
...
# returns: terms and topics
attributes(result)

# distribution of terms in topics 
beta <- result$terms
# distribution of topics in articles
theta <- result$topics
...
**want to start assignment with dat2 from last weeks asignment**
