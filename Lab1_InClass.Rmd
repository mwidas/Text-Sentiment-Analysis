...
API_KEY <- "6hhkGtqGPRh0yYlmO1CoGtqLtHgrSnvS"
```
...
```{r api, eval = FALSE}
#what type of object is it? It is a list
class(t)
...
x <- "When she took her oath of office, the first Native American cabinet secretary also took a stance for self-expression."
...
#swap strings
str_replace(x, "stance", "stand")

#how do we replace all of them?
str_replace_all(x, " ", "_")

#detect a string: asking if this input is present in the string aka is t in our string somewhere
str_detect(x, "t")

#locate the first place this shows up
str_locate(x, "t")

# locate all the places this shows up
str_locate_all(x, "t")
```
